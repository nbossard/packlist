...
/**
 * An implementation of {@link ISavingModule} based on shared preferences and json serialisation / deserialisation.
 *
...
public class PrefsSavingModule implements ISavingModule {
    ...
    public static final String LIST_TRIPS_KEY = "LIST_TRIPS";
    public static final String PREFS_FILENAME = "PREFS";
    private final Context mContext;
    private SharedPreferences mSharedPreferences;
    private Gson mGson;

    protected PrefsSavingModule(Context parContext) {
        mContext = parContext;
        mSharedPreferences = mContext.getSharedPreferences(PREFS_FILENAME, Context.MODE_PRIVATE);
        mGson = new Gson();
